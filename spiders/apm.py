...
class APM(of_spider.Spider):
    def parse_entry(self, driver):
        product_count = 0
        while True:
            elements = of_utils.find_elements_by_css_selector(driver, 'div.result-wrapper > a.result')
    ...
    def parse_product(self, driver):
        ...
        # images
        elements = of_utils.find_elements_by_css_selector(driver, 'div.image-item > img.img-responsive')
