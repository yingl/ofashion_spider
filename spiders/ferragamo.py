...
class Ferragamo(of_spider.Spider):
    def parse_entry(self, driver):
        product_count = 0
        while True:
            elements = of_utils.find_elements_by_css_selector(driver, 'article.cpd-product > div.cpd-product-content > a.ga-product-detail')
